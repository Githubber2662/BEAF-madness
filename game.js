...
/*function formatLargeNumMetaNum(num, decis) {
  if(!(decis instanceof Number)) decis = Number(String(decis));
  if(decis < 1) {
    return ;
  }
...
class Game {
  ...
  initializeUpgrades() {
    this.upgrades = {
      ...
      tetrationalGrowth: { id: 'tetrationalGrowth', name: 'Tetrational Growth', description: 'passive multiplier^^1.1', multiplier: new MetaNum(1.1), baseCost: new MetaNum("F40"), cost: new MetaNum("F40"), owned: new MetaNum(0), type: 'passive', hyper: new MetaNum(2)},
      pentationalGrowth: { id: 'pentationalGrowth', name: 'Pentational Growth', description: 'passive multiplier^^^1.07', multiplier: new MetaNum(1.07), baseCost: new MetaNum("G110"), cost: new MetaNum("G110"), owned: new MetaNum(0), type: 'passive', hyper: new MetaNum(3)}
    }
    };
