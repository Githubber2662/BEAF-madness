...
class Game {
  ...
  initializeUpgrades() {
    this.upgrades = {
      ...
      tetrationalGrowth: { id: 'tetrationalGrowth', name: 'Tetrational Growth', description: 'passive multiplier^^1.1', multiplier: new MetaNum(1.1), baseCost: new MetaNum("F1000"), cost: new MetaNum(2), owned: new MetaNum(0), type: 'passive', hyper: new MetaNum(1)}
    };
  }
  ...
  _purchaseCost(base, rate, count, owned = new MetaNum(0), hyper) {
